...
async def fetch_info(replied_user, event):
    ...
    replied_user_profile_photos = await event.client(
        GetUserPhotosRequest(user_id=replied_user.user.id,
                             ...
                             max_id=0,
                             limit=80))
    replied_user_profile_photos_count = "Butuh dibantu aplod poto profile dia."
    try:
...
CMD_HELP.update({
    "whois":
    ".whois <username> atau balas ke pesan seseorang dengan .whois\
    \nUsage: Liat Profile Orang."
})

CMD_HELP.update({
    "userinfo":
    ".userinfo <username> atau balas ke pesan seseorang dengan .userinfo\
    \nUsage: Liat Profile Orang."
})
